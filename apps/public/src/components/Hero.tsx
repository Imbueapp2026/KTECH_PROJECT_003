  ...
  return (
    <section className="relative h-screen min-h-[600px] flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
        <h1 className="text-5xl md:text-7xl font-serif font-semibold text-white mb-6 tracking-wide drop-shadow-sm">
          Timeless Elegance
        </h1>
        ...
        <Link
          href="/collections"
          className="inline-block px-8 py-4 bg-gold text-white font-medium hover:opacity-95 transition-all shadow-md border-b-4 border-dusty-rose"
        >
          Explore Collections
        </Link>
      </div>
